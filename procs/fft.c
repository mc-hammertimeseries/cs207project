...
#define __PYX_HAVE__cs207project__procs__fft
#define __PYX_HAVE_API__cs207project__procs__fft
#include "string.h"
#include "stdio.h"
#include "stdlib.h"
 ...
 */
typedef double __pyx_t_12cs207project_5procs_4cfft_double_c[2];
...
/* Module declarations from 'cs207project.procs.cfft' */

/* Module declarations from 'cs207project.procs.fft' */
#define __Pyx_MODULE_NAME "cs207project.procs.fft"
int __pyx_module_is_main_cs207project__procs__fft = 0;

/* Implementation of 'cs207project.procs.fft' */
...
#endif
{
  ...
  #endif
  if (__pyx_module_is_main_cs207project__procs__fft) {
  ...
  #if PY_MAJOR_VERSION >= 3
  {
    ...
    if (!PyDict_GetItemString(modules, "cs207project.procs.fft")) {
      if (unlikely(PyDict_SetItemString(modules, "cs207project.procs.fft", __pyx_m) < 0)) {__pyx_filename = __pyx_f[1]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init cs207project.procs.fft", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init cs207project.procs.fft");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
